<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="INVENTORY_SYSTEM.index" %>
...
<body  class="hold-transition sidebar-mini layout-fixed">
  ...
  <!-- Main Sidebar Container -->
           <style="background-color: #f0f0f000;></style>
  <aside  style="background-color:#00ffff; " class="main-sidebar sidebar-primary elevation-4">
    <!-- Brand Logo -->
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header" style="background-color:#808080">
