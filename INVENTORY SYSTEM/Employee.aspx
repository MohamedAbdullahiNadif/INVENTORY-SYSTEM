<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Employee.aspx.cs" Inherits="INVENTORY_SYSTEM.Employee" %>
...
<div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Employee Regsitration Frome</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <label>Phone</label>
                    <asp:TextBox ID="txtphone" CssClass="form-control"  placeholder="Enter Phone" required="" runat="server"></asp:TextBox>
                  </div>
                   <div class="col-4 form-group">
                    <label>Addres</label>
                    <asp:TextBox ID="txtAddres" CssClass="form-control" placeholder="Enter Addres" required="" runat="server"></asp:TextBox>
                  </div>
                     <div class="col-4 form-group">
                    <label>Email</label>
                    <asp:TextBox ID="txtEmail" CssClass="form-control" TextMode="Email" placeholder="Enter Email" required="" runat="server"></asp:TextBox>
                  </div>
                  </div>
                    <div class="row">
                          <div class="col-4 form-group">
                    <label>Job-Title</label>
                        <asp:DropDownList ID="ddlusertype" runat="server" Width="266px" Height="39px">
                            <asp:ListItem>Select Job Title</asp:ListItem>
                            <asp:ListItem>Manager</asp:ListItem>
                            <asp:ListItem>cashir</asp:ListItem>
                     ...
                     <div class="col-4 form-group">
                    <label>Salary</label>
                    <asp:TextBox ID="txtsalary" CssClass="form-control" placeholder="Enter Salary" required="" runat="server"></asp:TextBox>
                  </div>
                      <div class="col-4 form-group">
                    <label>Status</label>
                        <asp:DropDownList ID="ddlstatus" runat="server" Width="268px" Height="39px">
                            <asp:ListItem>Select Employee Status</asp:ListItem>
                ...
                <asp:Button ID="btnUpdet" CssClass="btn btn-success" formnovalidate="" runat="server" Text="Updete" OnClick="btnUpdet_Click" />
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1">
        <Columns>
            ...
            <asp:BoundField DataField="EmployeName" HeaderText="EmployeName" SortExpression="EmployeName" />
            ...
            <asp:BoundField DataField="Registerdate" HeaderText="Registerdate" SortExpression="Registerdate" />
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:INVENTORYConnectionString %>" SelectCommand="SELECT * FROM [Employee]"></asp:SqlDataSource>
