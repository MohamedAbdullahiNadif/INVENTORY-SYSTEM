<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Itome.aspx.cs" Inherits="INVENTORY_SYSTEM.Itome" %>
...
<div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Itome Regsitration Frome</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <asp:TextBox ID="txtitemname" CssClass="form-control"  placeholder="Enter Item Name"  runat="server"></asp:TextBox>
                  </div>
                  <div class="row">
                   ...
                   <div class="col-4 form-group">
                    <label>Qty</label>
                    <asp:TextBox ID="txtqty" CssClass="form-control" placeholder="Enter Qty"  runat="server"></asp:TextBox>
                  </div>
                     <div class="col-4 form-group">
                    <label>Regdate</label>
                    <asp:TextBox ID="txtregdate" CssClass="form-control" TextMode="Date" placeholder="Enter Regdate"  runat="server"></asp:TextBox>
                  </div>
                  </div>
                </div>
                <!-- /.card-body -->
                ...
                <asp:Button ID="btnUpdet" CssClass="btn btn-success" runat="server" Text="Updete" OnClick="btnUpdet_Click" />
                <asp:Button ID="btndelet" CssClass="btn btn-danger" runat="server" Text="Delet" OnClick="btndelet_Click" />
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:INVENTORYConnectionString %>" SelectCommand="SELECT * FROM [item] WHERE ([itemid] = @itemid)">
                        <SelectParameters>
                            <asp:ControlParameter ControlID="txt" Name="itemid" PropertyName="Text" Type="Int32" />
                        </SelectParameters>
                    </asp:SqlDataSource>
              </form>
            </div>
